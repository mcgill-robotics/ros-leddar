...
enum LdProperties {
  ...
  PID_ACQ_OPTIONS = 0x0000BC,  // 1: Automatic led intensity, 2: Automatic
                               // transimpedance gain, 4: Enable the two object
                               // demerge algorithm, 8: Disable xtalk removal
                               // algorithm (logical inverse)
  ...
  PID_CAN_OPTIONS = 0x0000D3,  // 1: Send detection on multiple message ID, 2:
                               // Delay in msec between a message sent in a
                               // message box(es), 4: Delay in msec between
                               // cycle of acquisition message frame, 8: Use
                               // detection message with flag information
  ...
  PID_ZONE_SEGMENT_ENABLED =
      0x0000C4,  // Bit 1 = Segment 1, Bit 2 = Segment 2 ... Bit 16 = Segment 16
